...
отеля из той же выдачи. Проверенный маршрут — LED → ОАЭ, один номер, точная дата,
1–6 взрослых и до трёх детей 0–16 лет; 0 означает младенца. За запрос допускается
до пяти вариантов длительности: например, 5–9 и затем 10–12 ночей.
